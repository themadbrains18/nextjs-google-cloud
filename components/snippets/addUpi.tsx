        ...
        <div className="py-30 md:py-10">
          ...
          <div className="flex flex-col mb-[15px] md:mb-5 gap-[6px]">
            ...
            <div className="border border-grey-v-1 dark:border-opacity-[15%]  rounded-5 p-[11px] md:p-[15px]">
              <input type="text" placeholder="Name" className="outline-none sm-text w-full bg-[transparent]" />
            </div>
          </div>
          <div className="flex flex-col  gap-[6px]">
            <label className="sm-text">UPI Id</label>
            <div className="border border-grey-v-1 dark:border-opacity-[15%]  rounded-5 p-[11px] md:p-[15px]">
              <input type="text" placeholder="UPI Id" className="outline-none sm-text w-full bg-[transparent]" />
            </div>
          </div>
        </div>
